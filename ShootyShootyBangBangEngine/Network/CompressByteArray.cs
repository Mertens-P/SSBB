...
{
    public class NetCompressByteArray
    {
        #region Envelope
            ...
            byte[] inputBuffer, int inputOffset = 0, int inputLength = int.MaxValue)
        {
            ...
            outputLength = Lz4Net.Lz4.Compress(inputBuffer, inputOffset, inputLength, ref outputBuffer, 0);
            ...
            byte[] inputBuffer, int inputOffset = 0)
        {
            ...
            else
            {
                ...
                Lz4Net.Lz4.Decompress(inputBuffer, inputOffset + WRAP_OFFSET_8, ref result);
            }
